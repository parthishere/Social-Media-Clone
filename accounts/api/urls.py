...
urlpatterns = [
    ...
    path('?P<id>[\d\-]+$/', retrive_profile, name='profile-detail'),
    path('', UserProfileListAPI.as_view(), name='profile-list'),
    path('follow/<int:id>/', follow_requested_user, name='follow-profile'),
    path('user-followers/<int:id>', get_requested_user_followers, name='user-followers'),
    path('user-following/<int:id>', get_requested_user_following, name='user-following'),
